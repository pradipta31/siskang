      ...
      body: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Center(child: Image.asset('asset/images/logo.png', width: 200, height: 150)),
                Padding(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            ...
                            style: TextStyle(
                                fontSize: 40.0, color: Color.fromARGB(255, 226, 225, 225)),
                        ...
                        Text(
                          ...
                          style:
                              TextStyle(fontSize: 15.0, color: Color.fromARGB(255, 226, 225, 225)),
                          textAlign: TextAlign.center,
                        ),
