  ...
  ResearchTimelineModel _listingTimeline(ResearchTimelineModel data) {
    data.listedTimeline = {
      "0": {
        ...
        "date": data.proposalUploadDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.proposalUploadDate,
        "status": !data.proposalUploadDate!.toLowerCase().startsWith('un', 2)
      },
      "1": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 1,
        "name": "Pengajuan Proposal",
        "date": data.proposalSubmissionDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.proposalSubmissionDate,
        "status": !data.proposalSubmissionStat!.toLowerCase().startsWith('un', 2)
      },
      "2": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 2,
        "name": "Verifikasi Proposal",
        "date": data.proposalVerifDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.proposalVerifDate,
        "status": !data.proposalVerifDate!.toLowerCase().startsWith('un', 2)
      },
      "3": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 2,
        "name": "Verifikasi Kelayakan Proposal",
        "date": data.eligibilityVerifDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.eligibilityVerifDate,
        "status": !data.eligibilityProposal!.toLowerCase().startsWith('un', 2)
      },
      "4": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 2,
        "name": "Ujian Proposal",
        "date": data.proposalVerifDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.proposalVerifDate,
        "status": !data.proposalTestVerif!.toLowerCase().startsWith('un', 2)
      },
      "5": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 2,
        "name": "Revisi Proposal",
        "date": data.proposalRevVerifDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.proposalRevVerifDate,
        "status": !data.proposalRevVerif!.toLowerCase().startsWith('un', 2)
      },
      "6": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 2,
        "name": "Upload Pra Tesis",
        "date": data.preThesisUpDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.preThesisUpDate,
        "status": !data.preThesisUpDate!.toLowerCase().startsWith('un', 2)
      },
      "7": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 3,
        "name": "Uji Kelayakan Pra Tesis",
        "date": data.preThesisEligVerifDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.preThesisEligVerifDate,
        "status": !data.preThesisEligVerif!.toLowerCase().startsWith('un', 2)
      },
      "8": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 3,
        "name": "Ujian Pra Tesis",
        "date": data.preThesisTestStatDate?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.preThesisTestStatDate,
        "status": !data.preThesisTestStat!.toLowerCase().startsWith('un', 2)
      },
      "9": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 3,
        "name": "Revisi Pra Tesis",
        "date": data.tglStatusPratesisPevisi?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.tglStatusPratesisPevisi,
        "status": !data.preThesisRevStat!.toLowerCase().startsWith('un', 2)
      },
      "10": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 4,
        "name": "Upload Tesis",
        "date": data.tglTesisUpload?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.tglTesisUpload,
        "status": !data.tglTesisUpload!.toLowerCase().startsWith('un', 2)
      },
      "11": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 4,
        "name": "Verifikasi Kelayakan Tesis",
        "date": data.tglVerifikasiTesisKelayakan?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.tglVerifikasiTesisKelayakan,
        "status": !data.verifikasiTesisKelayakan!.toLowerCase().startsWith('un', 2)
      },
      "12": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 4,
        "name": "Ujian Tesis",
        "date": data.tglTesisUjian?.toLowerCase().startsWith('un', 2) ?? false
            ? "TBD"
            : data.tglTesisUjian,
        "status": !data.statusTesisUjian!.toLowerCase().startsWith('un', 2)
      },
      "13": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 4,
        "name": "Revisi Tesis",
        "date": !data.statusTesisUjian!.toLowerCase().startsWith('un', 2)
            ? data.verifikasiTesisRevisi
            : null,
        "status": !data.verifikasiTesisRevisi!.toLowerCase().startsWith('un', 2)
      },
      "14": {
        "show": _tahapPenelitian(data.tahapPenelitian!) <= 5,
        "name": "Done",
        "date": !data.verifikasiTesisRevisi!.toLowerCase().startsWith('un', 2)
            ? data.verifikasiTesisRevisi
            : null,
        "status": !data.verifikasiTesisRevisi!.toLowerCase().startsWith('un', 2)
      },
